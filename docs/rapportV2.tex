...
\begin{paraph}{Avantages}
    \begin{itemize}
        ...
        Cela peut être avantageux dans le cas ou l'on souhaite 
...
\begin{paraph}{Analyse des graphiques (Annexe \ref{annexe:graphiques})}
...
\addcontentsline{toc}{section}{Conclusion}
    ...
    \vspace{0.3cm}
    Plusieurs pistes d'amélioration restent ouvertes. L'implémentation de Martelli-Montanari pourrait être optimisée en s'approchant de sa complexité quasi-linéaire théorique grâce à une structure union-find. La représentation des termes sous forme de graphes avec partage de sous-termes, constituerait une direction naturelle pour réduire les coûts de l'occur-check et des substitutions.
...
\appendix
\section{Annexes}
\subsection{Résultats de l'arbre de discrimination}
\label{annexe:DT}
...
\subsection{Résultats de l'algorithme de Robinson}
...
\subsection{Résultats de l'algorithme Martelli-Montanari}
\label{annexe:MM}
