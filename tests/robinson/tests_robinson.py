...
from unification.utils.stores import SetStore
from unification.robinson import rechercherUnifiablesSimple, afficherResultat, unifLitteraux


############## Test unifLitteraux #######################

def testUnifLitteraux():
    """
    Teste la fonction unifLitteraux avec des cas précis et intéressants.
    Affichage créé par IA(les print etc), exemples et valeur des tests faits par moi
    """
    print("="*60)
    print("TESTS DE LA FONCTION unifLitteraux")
    print("="*60)
...
res = rechercherUnifiablesSimple(l1, set)
