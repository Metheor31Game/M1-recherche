...
\begin{paraph}{Insertion}
    ...
    \begin{algorithm}[H]
        \footnotesize
        \caption{Insertion d'un prédicat dans l'arbre de discrimination}
        \label{alg:insertion_dt}
        \begin{algorithmic}[1]
...
\begin{paraph}{Filtrage structurel}
    ...
    \begin{algorithm}[H]
        \footnotesize
        \caption{Filtrage structurel (Collecte de candidats)}
        \label{alg:filtrage_dt}
        \begin{algorithmic}[1]
