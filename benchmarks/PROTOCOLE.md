...
10. L'utilisation de Python ne doit **pas** être un facteur dans ces tests — en d'autres termes, ce protocole devra être perméable à ce que l'on appellera les pythoneries™©®.
    ...
    > _"pythoneries"_ est une marque déposée de notre équipe de recherche. Toute reproduction, même partielle, même en Python, est — ironiquement — strictement interdite. Les contrevenants seront contraints de réécrire leur code en PROLOG.
